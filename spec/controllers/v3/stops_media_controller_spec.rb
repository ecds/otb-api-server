...
RSpec.describe(V3::StopMediaController, type: :controller) do
  ...
  describe 'POST #create' do
    ...
    it 'returns 401' do
      ...
      signed_cookie(user)
      post :create,
        params: { data: { type: 'stop_media', attributes: { stop_id: 1, medium_id: 1, position: 1 } }, tenant: Apartment::Tenant.current }
    ...
    context 'with valid params' do
      it 'renders a JSON response with the v3_stop_medium' do
        ...
        put :update,
          params: {
            id: stop_medium.id,
            data: { type: 'stop_media', attributes: { stop_id: stop_medium.stop.id, medium_id: stop_medium.medium.id, position: 100 } },
