...
RSpec.describe(V3::TourMediaController, type: :controller) do
  describe 'GET #index' do
    ...
    context 'unauthenticated' do
      it 'returns a success response but zero TourMedium objects' do
        create(:tour_medium, tour: create(:tour, published: false))
      ...
      it 'returns a success response but zero TourMedium objects' do
        create(:tour_medium, tour: create(:tour, published: true))
        get :index, params: { tenant: Apartment::Tenant.current }
        expect(response.status).to(eq(200))
  ...
  describe 'POST #create' do
    ...
    it 'returns 401' do
      ...
      signed_cookie(user)
      post :create,
        params: { data: { type: 'tour_media', attributes: { tour_id: 1, medium_id: 1, position: 1 } }, tenant: Apartment::Tenant.current }
    ...
    context 'with valid params' do
      ...
      it 'renders a JSON response with the v3_tour_medium' do
        ...
        put :update,
          params: {
            id: tour_medium.id,
            data: { type: 'tour_media', attributes: { tour_id: tour_medium.tour.id, medium_id: tour_medium.medium.id, position: 100 } },
